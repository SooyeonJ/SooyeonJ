...
- 멀티 클라우드(NIA·네이버·카카오·더존) 운영 · 2025년 국가정보자원관리원 화재 복구 참여
...
#### 📈 DB GAPS - ETF Portfolio Competition *(2026, -ing)*
- 퀀트 담당 · 매크로-모멘텀-퀀트 전략 수치화 및 백테스팅 · pykrx 기반 ETF 188개 수집

#### 💡 건강보험심사평가원 — 보건의료빅데이터·AI 활용 창업경진대회 *(2026, -ing)*
- 의료·금융 융합 서비스 **MediCost AI** 개발 중 — 의료 마이데이터 기반 약제비 재무 분석
- 투약이력 PDF → AI 자동 분석 → 약제비 흐름·재무 리스크 시각화
